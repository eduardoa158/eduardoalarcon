  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col h-[280px]">
        {/* Title - Altura fija */}
        <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-green-600 transition-colors h-7 overflow-hidden">
          {product.name}
        </h3>

        {/* Description - Altura fija */}
        <p className="text-gray-600 text-sm mb-4 line-clamp-2 leading-relaxed h-10 overflow-hidden">
          {product.description}
        </p>
